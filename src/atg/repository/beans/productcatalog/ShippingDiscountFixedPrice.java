...
public class ShippingDiscountFixedPrice extends ShippingDiscount implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Shipping Discount - Fixed Price";                                                                          
   ...
   public ShippingDiscountFixedPrice()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public ShippingDiscountFixedPrice(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public ShippingDiscountFixedPrice getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",ShippingDiscountFixedPrice.class);
   }

   public void setParentFolderThis(ShippingDiscountFixedPrice pParentFolder){
   ...
   public ShippingDiscountFixedPrice getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",ShippingDiscountFixedPrice.class);
   }

   public void setStackingRuleThis(ShippingDiscountFixedPrice pStackingRule){
   ...
   public Boolean getOneUsePerOrderThis(){
      return getSimpleProperty("oneUsePerOrder",Boolean.class);
   }

   public void setOneUsePerOrderThis(Boolean pOneUsePerOrder){
      setSimpleProperty("oneUsePerOrder", pOneUsePerOrder);
   }
