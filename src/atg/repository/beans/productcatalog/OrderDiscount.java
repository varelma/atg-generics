...
public class OrderDiscount extends Promotion implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Order Discount";                                                                          
   ...
   public OrderDiscount(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public OrderDiscount getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",OrderDiscount.class);
   }

   public void setParentFolderThis(OrderDiscount pParentFolder){
   ...
   public OrderDiscount getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",OrderDiscount.class);
   }

   public void setStackingRuleThis(OrderDiscount pStackingRule){
