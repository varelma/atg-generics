...
public class ShippingDiscountAmountOff extends ShippingDiscount implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Shipping Discount - Amount Off";                                                                          
   ...
   public ShippingDiscountAmountOff()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public ShippingDiscountAmountOff(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public ShippingDiscountAmountOff getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",ShippingDiscountAmountOff.class);
   }

   public void setParentFolderThis(ShippingDiscountAmountOff pParentFolder){
   ...
   public ShippingDiscountAmountOff getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",ShippingDiscountAmountOff.class);
   }

   public void setStackingRuleThis(ShippingDiscountAmountOff pStackingRule){
