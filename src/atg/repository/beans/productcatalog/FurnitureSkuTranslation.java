...
public class FurnitureSkuTranslation extends SkuTranslation implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "furniture-sku-translation";                                                                          
   ...
   public FurnitureSkuTranslation()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public FurnitureSkuTranslation(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
