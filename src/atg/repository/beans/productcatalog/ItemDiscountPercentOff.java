...
public class ItemDiscountPercentOff extends ItemDiscount implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Item Discount - Percent Off";                                                                          
   ...
   public ItemDiscountPercentOff()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public ItemDiscountPercentOff(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public ItemDiscountPercentOff getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",ItemDiscountPercentOff.class);
   }

   public void setParentFolderThis(ItemDiscountPercentOff pParentFolder){
   ...
   public ItemDiscountPercentOff getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",ItemDiscountPercentOff.class);
   }

   public void setStackingRuleThis(ItemDiscountPercentOff pStackingRule){
