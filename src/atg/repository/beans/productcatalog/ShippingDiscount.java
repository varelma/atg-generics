...
public class ShippingDiscount extends Promotion implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Shipping Discount";                                                                          
   ...
   public ShippingDiscount(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public ShippingDiscount getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",ShippingDiscount.class);
   }

   public void setParentFolderThis(ShippingDiscount pParentFolder){
   ...
   public ShippingDiscount getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",ShippingDiscount.class);
   }

   public void setStackingRuleThis(ShippingDiscount pStackingRule){
   ...
   public Boolean getOneUsePerOrder(){
      return getSimpleProperty("oneUsePerOrder",Boolean.class);
   }

   public void setOneUsePerOrder(Boolean pOneUsePerOrder){
