...
public class ShippingDiscountPercentOff extends ShippingDiscount implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Shipping Discount - Percent Off";                                                                          
   ...
   public ShippingDiscountPercentOff()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public ShippingDiscountPercentOff(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public ShippingDiscountPercentOff getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",ShippingDiscountPercentOff.class);
   }

   public void setParentFolderThis(ShippingDiscountPercentOff pParentFolder){
   ...
   public ShippingDiscountPercentOff getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",ShippingDiscountPercentOff.class);
   }

   public void setStackingRuleThis(ShippingDiscountPercentOff pStackingRule){
