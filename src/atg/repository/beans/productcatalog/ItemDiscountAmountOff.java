...
public class ItemDiscountAmountOff extends ItemDiscount implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Item Discount - Amount Off";                                                                          
   ...
   public ItemDiscountAmountOff()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public ItemDiscountAmountOff(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public ItemDiscountAmountOff getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",ItemDiscountAmountOff.class);
   }

   public void setParentFolderThis(ItemDiscountAmountOff pParentFolder){
   ...
   public ItemDiscountAmountOff getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",ItemDiscountAmountOff.class);
   }

   public void setStackingRuleThis(ItemDiscountAmountOff pStackingRule){
