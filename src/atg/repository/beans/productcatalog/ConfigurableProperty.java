...
public class ConfigurableProperty extends MutableRepositoryItemExt implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "configurableProperty";                                                                          
   ...
   public ConfigurableProperty(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public List<ConfigurationOption> getConfigurationOptions(){
      return getListProperty("configurationOptions", ConfigurationOption.class);
   }

   public void setConfigurationOptions(List<ConfigurationOption> pConfigurationOptions){
       setListProperty("configurationOptions", pConfigurationOptions);
   } 
