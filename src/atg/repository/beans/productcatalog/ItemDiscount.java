...
public class ItemDiscount extends Promotion implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Item Discount";                                                                          
   ...
   public ItemDiscount(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public ItemDiscount getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",ItemDiscount.class);
   }

   public void setParentFolderThis(ItemDiscount pParentFolder){
   ...
   public Boolean getFilterForTargetActedAsQualifier(){
      return getSimpleProperty("filterForTargetActedAsQualifier",Boolean.class);
   }

   public void setFilterForTargetActedAsQualifier(Boolean pFilterForTargetActedAsQualifier){
   ...
   public Boolean getFilterForTargetPriceLTOETPromoPrice(){
      return getSimpleProperty("filterForTargetPriceLTOETPromoPrice",Boolean.class);
   }

   public void setFilterForTargetPriceLTOETPromoPrice(Boolean pFilterForTargetPriceLTOETPromoPrice){
   ...
   public Boolean getFilterForTargetDiscountedByCurrent(){
      return getSimpleProperty("filterForTargetDiscountedByCurrent",Boolean.class);
   }

   public void setFilterForTargetDiscountedByCurrent(Boolean pFilterForTargetDiscountedByCurrent){
   ...
   public Boolean getFilterForTargetNegativePrices(){
   ...
   public Boolean getFilterForTargetOnSale(){
   ...
   public Boolean getFilterForQualifierDiscountedByCurrent(){
      return getSimpleProperty("filterForQualifierDiscountedByCurrent",Boolean.class);
   }

   public void setFilterForQualifierDiscountedByCurrent(Boolean pFilterForQualifierDiscountedByCurrent){
      setSimpleProperty("filterForQualifierDiscountedByCurrent", pFilterForQualifierDiscountedByCurrent);
   }


   public Boolean getFilterForTargetDiscountedByAny(){
      return getSimpleProperty("filterForTargetDiscountedByAny",Boolean.class);
   }

   public void setFilterForTargetDiscountedByAny(Boolean pFilterForTargetDiscountedByAny){
   ...
   public Boolean getFilterForTargetZeroPrices(){
   ...
   public ItemDiscount getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",ItemDiscount.class);
   }

   public void setStackingRuleThis(ItemDiscount pStackingRule){
