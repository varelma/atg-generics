...
public class OrderDiscountPercentOff extends OrderDiscount implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Order Discount - Percent Off";                                                                          
   ...
   public OrderDiscountPercentOff()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public OrderDiscountPercentOff(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public OrderDiscountPercentOff getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",OrderDiscountPercentOff.class);
   }

   public void setParentFolderThis(OrderDiscountPercentOff pParentFolder){
   ...
   public OrderDiscountPercentOff getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",OrderDiscountPercentOff.class);
   }

   public void setStackingRuleThis(OrderDiscountPercentOff pStackingRule){
