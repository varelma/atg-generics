...
public class MediaInternalBinary extends Media implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "media-internal-binary";                                                                          
   ...
   public MediaInternalBinary()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public MediaInternalBinary(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public MediaInternalBinary getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",MediaInternalBinary.class);
   }

   public void setParentFolderThis(MediaInternalBinary pParentFolder){
