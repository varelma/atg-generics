...
public class PromotionTranslation extends MutableRepositoryItemExt implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "promotionTranslation";                                                                          
   ...
   public PromotionTranslation()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public PromotionTranslation(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
