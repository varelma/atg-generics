...
public class OrderDiscountAmountOff extends OrderDiscount implements java.io.Serializable {                                            
   static transient MutableRepository REPOSITORY;                                                                                         
   static transient String DESCRIPTOR = "Order Discount - Amount Off";                                                                          
   ...
   public OrderDiscountAmountOff()  {                                                                                                           
   }                                                                                                                                      
                                                                                                                                          
   public OrderDiscountAmountOff(MutableRepositoryItem delegate) {                                                                              
      super(delegate);                                                                                                                    
   }                                                                                                                                      
   ...
   public OrderDiscountAmountOff getParentFolderThis(){
      return getSingleRepositoryProperty("parentFolder",OrderDiscountAmountOff.class);
   }

   public void setParentFolderThis(OrderDiscountAmountOff pParentFolder){
   ...
   public OrderDiscountAmountOff getStackingRuleThis(){
      return getSingleRepositoryProperty("stackingRule",OrderDiscountAmountOff.class);
   }

   public void setStackingRuleThis(OrderDiscountAmountOff pStackingRule){
